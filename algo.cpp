...
int main()
{
   gotoxy(1,2);
	...
	gotoxy(6,11);
	cout << "     **************************************************************" << endl;
        cout<<"RAMU DAIRY PROBLEM";
        cout<<endl<<endl<<"Sub By:Medha saha(16104040)"<<endl<<"  "<<"Samyak Jain(16104047)"<<endl<<"  "<<"Abhishek dalakoti(16104024)"<<endl<<"  "<<"Chhavi singhal(16104048)";
    delay(4000);
    system("cls");
